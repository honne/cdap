...
public class CreateNamespaceCommand extends AbstractCommand {
  ...
  public void perform(Arguments arguments, PrintStream output) throws Exception {
    ...
    String description = arguments.getOptional(ArgumentName.NAMESPACE_DESCRIPTION.toString(), "");
    ...
    String schedulerQueueName = arguments.getOptional(ArgumentName.NAMESPACE_SCHEDULER_QUEUENAME.toString(), "");
